    ...
    _createClass(SchemaForm, [{
        ...
        value: function builder(form, model, index, onChange, mapper) {
            ...
            return _react2.default.createElement(
                'div',
                { key: index, style: { marginTop: 10, minWidth: 360, width: "100%" } },
                _react2.default.createElement(Field, { model: model, form: form, onChange: onChange, mapper: mapper, builder: this.builder })
            );
        }
    }, {
        key: 'render',
